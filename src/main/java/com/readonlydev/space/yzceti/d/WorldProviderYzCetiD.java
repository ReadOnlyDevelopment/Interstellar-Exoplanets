...
import com.readonlydev.space.yzceti.d.worldgen.BiomeProviderYzCetiD;
...
public class WorldProviderYzCetiD extends WorldProviderExoplanet {
	...
	public Class<? extends BiomeProvider> getBiomeProviderClass () {
		BiomeAdaptive.setBodyMultiBiome(ExoplanetRegistry.YZCETID);
		return BiomeProviderYzCetiD.class;
	}

	@Override
	public CelestialBody getCelestialBody () {
		return ExoplanetRegistry.YZCETID;
	}
