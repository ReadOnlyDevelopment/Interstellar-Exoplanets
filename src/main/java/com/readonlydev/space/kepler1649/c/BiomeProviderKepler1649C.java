...
import com.readonlydev.space.kepler1649.c.layer.GenLayerKepler1649C;
...
public class BiomeProviderKepler1649C extends BiomeProvider {
	...
	protected BiomeProviderKepler1649C() {
		this.body            = ExoplanetRegistry.KEPLER1649C;
		this.biomeCache      = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderKepler1649C(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerKepler1649C.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes   = genLayers[1];
	}

	public BiomeProviderKepler1649C(World world) {
