...
import com.readonlydev.api.space.utility.AstronomicalConstants;
...
public class SkyProviderWolf1061C extends IRenderHandler {
	...
	private static final ResourceLocation sunTexture = Assets.getCelestialTexture("wolf1061star");
	...
	public SkyProviderWolf1061C(IGalacticraftWorldProvider erisProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderWolf1061C.sunTexture);
	...
	public float getSkyBrightness(float par1) {
		...
		float var3 = 1.0F - (MathHelper.sin((float) (var2 * AstronomicalConstants.PI_OVER_TWO)) * 2.0F + 0.25F);
