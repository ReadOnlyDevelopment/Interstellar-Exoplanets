...
import static com.readonlydev.ExoInfo.Constants.CATEGORY_CORE;
import static com.readonlydev.ExoInfo.Constants.CATEGORY_CORE_PERFORMANCE;
import static com.readonlydev.ExoInfo.Constants.LGKEY_CATEGORY_CORE;
...
public class ConfigCore {
	...
	public static void syncConfig(boolean load) {
		try {
			...
			prop.setComment(
					"How long, in ms, the /locatebiome command will search for biomes before timing out, normally 20000ms");
			...
			Exoplanets.log.warn("Intersteller Core Config had an issue loading the config file!");
		}
	}
