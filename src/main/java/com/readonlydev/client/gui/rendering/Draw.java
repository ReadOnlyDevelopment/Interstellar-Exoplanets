...
import com.readonlydev.client.ClientUtil;
...
public class Draw {
	...
	public static void drawString (String text, int x, int y, int color, boolean shadow) {
		...
		text = Exoplanets.translate.translate(text);
	...
	public static void drawStringAlignCenter (String text, int x, int y, int w, int h, int color, boolean shadow) {
		drawString(text, x + (w - Draw.getStringRenderWidth(Exoplanets.translate.translate(text))) / 2, y
				+ (h - 8) / 2, color, shadow);
	}
	...
	public static void drawStringAlignCenter (String text, int x, int y, int color, boolean shadow) {
		drawString(text, x - Draw.getStringRenderWidth(Exoplanets.translate.translate(text)) / 2, y, color, shadow);
	}
	...
	public static void drawStringAlignRight (String text, int x, int y, int color, boolean shadow) {
		drawString(text, x - Draw.getStringRenderWidth(Exoplanets.translate.translate(text)), y, color, shadow);
	}
