...
package com.readonlydev.client.gui.screen;
...
import com.readonlydev.client.gui.screen.components.GuiDiscordButton;
	...
	protected void actionPerformed (GuiButton button) {
		...
		case 1:
			try {
				...
				ReflectionMethods.findField(GuiScreen.class, "clickedLinkURI", "field_175286_t")
