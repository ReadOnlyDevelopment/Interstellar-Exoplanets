...
import net.romvoid95.common.config.biomes.property.ConfigPropertyArray.*;
...
public abstract class Config {
    ...
    public void loadConfig() {
        ...
        try {
            ...
            ExoplanetsMod.logger.error("Exoplanets had a problem loading biome config: {}", configFile);
        }
        finally {
