...
public class ConfigSimplexCave {
	@Config.Name("Simplex Cave Minimum Altitude")
	@Config.Comment(
			"The minimum y-coordinate at which Simplex caves can generate.\n" +
			"Default: 1")
	@Config.RangeInt(min = 0, max = 255)
	@Config.RequiresWorldRestart
	public int caveBottom = 1;

	@Config.Name("Simplex Cave Maximum Altitude")
	@Config.Comment(
			"The maximum y-coordinate at which Simplex caves can generate.\n" +
			"Default: 80")
	@Config.RangeInt(min = 0, max = 255)
	@Config.RequiresWorldRestart
	public int caveTop = 80;

	@Config.Name("Simplex Cave Surface Cutoff Depth")
	@Config.Comment(
			"The depth from a given point on the surface at which Simplex caves start to close off.\n" +
	...
	@Config.Name("Simplex Cave Priority")
	@Config.Comment(
			"Determines how frequently Simplex Caves spawn. 0 = will not spawn at all.\n" +
			"Default: 5")
	...
	public class Advanced {
		...
		@Config.Comment("This value is currently unused for Simplex caves. ")
