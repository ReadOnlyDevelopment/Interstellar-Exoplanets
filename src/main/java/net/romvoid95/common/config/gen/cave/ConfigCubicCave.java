...
public class ConfigCubicCave {
	@Config.Name("Cublic Cave Minimum Altitude")
	@Config.Comment(
			"The minimum y-coordinate at which Cublic caves can generate.\n" +
			"Default: 1")
	@Config.RangeInt(min = 0, max = 255)
	@Config.RequiresWorldRestart
	public int caveBottom = 1;

	@Config.Name("Cublic Cave Maximum Altitude")
	@Config.Comment(
			"The maximum y-coordinate at which Cublic caves can generate.\n" +
			"Default: 80")
	@Config.RangeInt(min = 0, max = 255)
	@Config.RequiresWorldRestart
	public int caveTop = 80;

	@Config.Name("Cublic Cave Surface Cutoff Depth")
	@Config.Comment(
			"The depth from a given point on the surface at which Cublic caves start to close off.\n" +
	...
	@Config.Name("Cublic Cave Priority")
	@Config.Comment(
			"Determines how frequently Cublic Caves spawn. 0 = will not spawn at all.\n" +
			"Default: 10")
