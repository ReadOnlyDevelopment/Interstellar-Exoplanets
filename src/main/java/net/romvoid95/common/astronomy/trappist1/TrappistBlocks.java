...
public class TrappistBlocks {
	...
	public static class TrappistD {
		...
		public static final Block TRAP1D_OCEANFLOOR = new BlockMetamorphicRock();
		public static final Block TRAP1D_STONE_1    = new BlockIgneousRock();
		public static final Block TRAP1D_STONE_2    = new BlockIgneousRock();
		public static final Block TRAP1D_SOFTSTONE  = new BlockIgneousRock();
	...
	public static class TrappistE {
		...
		public static final Block TRAP1E_COBBLESTONE = new BlockMetamorphicRock();
		public static final Block TRAP1E_STONE       = new BlockMetamorphicRock();
