...
package net.romvoid95.common.astronomy.yzceti.c.worldgen.biomes.genlayers;
...
public class GenLayerYzCetiCBiomes extends GenLayer {
    ...
    private static final Biome[] biomes = BiomeAdaptive.getBiomesListFor(Planets.yzcetic).toArray(new Biome[0]);
