...
public class AABBUtil {
	...
	public static AxisAlignedBB[] getCollisionBoundingBoxes (World world, Block block, BlockPos pos) {
		return getCollisionBoundingBoxes(world, new ExBlockState(pos, block), false);
	}
	...
	public static AxisAlignedBB[] getCollisionBoundingBoxes (World world, Block block, BlockPos pos, boolean offset) {
		return getCollisionBoundingBoxes(world, new ExBlockState(pos, block), offset);
	}

	/**
	 * Gets the collision {@link AxisAlignedBB} for the {@link ExBlockState}.
	 *
	 * @param world the world
	 * @param state the state
	 * @return the collision bounding boxes
	 */
	public static AxisAlignedBB[] getCollisionBoundingBoxes (World world, ExBlockState state) {
