...
public class VarPagingHelper<B extends Block, V extends Enum<V> & IStringSerializable & IPagedVar>
{
    ...
    public VarPagingHelper(int variantsPerPage, Class<V> variantsEnumClass)
    {
        this(variantsPerPage, variantsEnumClass, Predicates.alwaysTrue());
    }
    
    public VarPagingHelper(int variantsPerPage, Class<V> variantsEnumClass, Predicate<V> filter)
    {
