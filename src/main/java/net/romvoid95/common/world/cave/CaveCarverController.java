...
public class CaveCarverController {
    ...
    public CaveCarverController(World worldIn, ConfigHolder config) {
        ...
        ExoplanetsMod.logger.debug("CAVE INFORMATION");
        ExoplanetsMod.logger.debug("--> MAX POSSIBLE THRESHOLD: " + maxPossibleNoiseThreshold);
        ExoplanetsMod.logger.debug("--> TOTAL PRIORITY: " + totalPriority);
        ExoplanetsMod.logger.debug("--> TOTAL RANGE LENGTH: " + totalRangeLength);
