...
public class TerrainSettings {
	...
	public TerrainSettings setDefaults() {
		...
		PresetOctave.DEFAULT.copyWeights(this.octaveWeights);
		return this;
	}
	...
	public static TerrainSettings forVanillaBiome(Biome biome) {
		...
		return (new TerrainSettings()).setDefaults().avgHeight(avgHeight).heightVariation(variationAbove,
				variationBelow).sidewaysNoise(0.9D);
