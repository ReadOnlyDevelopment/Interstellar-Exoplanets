...
package net.romvoid95.common.world.biome.genlayer;

import net.minecraft.world.gen.layer.GenLayer;
import net.minecraft.world.gen.layer.GenLayerVoronoiZoom;
import net.minecraft.world.gen.layer.GenLayerZoom;
import net.romvoid95.common.astronomy.yzceti.c.worldgen.biomes.genlayers.GenLayerYzCetiCBiomes;

public abstract class GenLayerExo extends GenLayer {

	public GenLayerExo(long l) {
		super(l);
	}
