...
import net.romvoid95.common.world.biome.features.WorldGenSurfacePatch;

public class BiomeThicket extends Biome implements WorldGenConstants {

	protected static final WorldGenSurfacePatch PODZOL_PATCH_FEATURE = new WorldGenSurfacePatch(Blocks.DIRT
			.getDefaultState().withProperty(BlockDirt.VARIANT, BlockDirt.DirtType.PODZOL), 6);
	protected static final WorldGenPatch        GRAVEL_PATCH_FEATURE = new WorldGenPatch(Blocks.GRAVEL
			.getDefaultState(), 4);
	...
	public void decorate (World worldIn, Random rand, BlockPos pos) {
		...
		if (net.minecraftforge.event.terraingen.TerrainGen
				.decorate(worldIn, rand, pos, DecorateBiomeEvent.Decorate.EventType.TREE)) {
		...
		if (net.minecraftforge.event.terraingen.TerrainGen
				.decorate(worldIn, rand, pos, DecorateBiomeEvent.Decorate.EventType.GRASS)) {
