...
public class BiomeWoodlands extends Biome implements WorldGenConstants {
	...
	public BiomeWoodlands() {
		...
		for (BlockFlower.EnumFlowerType type : BlockFlower.EnumFlowerType.values()) {
			...
			addFlower(net.minecraft.init.Blocks.RED_FLOWER.getDefaultState()
					.withProperty(net.minecraft.init.Blocks.RED_FLOWER.getTypeProperty(), type), 10);
		}
	}
	...
	public void decorate (World worldIn, Random rand, BlockPos pos) {
		if (net.minecraftforge.event.terraingen.TerrainGen
				.decorate(worldIn, rand, pos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.TREE)) {
