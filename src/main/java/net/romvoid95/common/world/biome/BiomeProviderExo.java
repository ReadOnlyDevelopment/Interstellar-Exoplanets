...
import net.romvoid95.common.astronomy.yzceti.c.worldgen.biomes.genlayers.GenLayerYzCetiC;

public abstract class BiomeProviderExo extends BiomeProvider {
	...
	protected BiomeProviderExo() {
		biomeCache      = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderExo(CelestialBody body, long seed, WorldType type) {
		this();
		this.body = body;
		GenLayer[] genLayers = GenLayerYzCetiC.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes   = genLayers[1];
	}

	public BiomeProviderExo(CelestialBody body, World world) {
