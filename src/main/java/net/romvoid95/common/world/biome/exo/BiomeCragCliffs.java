...
//import net.romvoid95.common.world.biome.features.WorldGenPlant;
//import prospector.traverse.init.TraverseBlocks;
//
//public class BiomeCragCliffs extends Biome implements WorldGenConstants {
//
//	protected static final WorldGenBlockBlob BOULDER_FEATURE    = new WorldGenBlockBlob(TraverseBlocks.blocks
//			.get("blue_rock_cobblestone"), 2);
//	public static final WorldGenerator       COLD_GRASS_FEATURE = new WorldGenPlant(TraverseBlocks.blocks
//			.get("cold_grass").getDefaultState());
...
//		super(properties);
//		blueRock                  = Blocks.IRON_BLOCK.getDefaultState();
//		topBlock                  = blueRock;
