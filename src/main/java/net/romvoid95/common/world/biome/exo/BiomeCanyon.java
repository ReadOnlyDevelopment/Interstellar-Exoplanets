...
public class BiomeCanyon extends BiomeSpace implements WorldGenConstants {

	public static final WorldGenerator DEAD_GRASS_FEATURE = new WorldGenPlant(ExoBlocks.log_a_dark1.getDefaultState());
	...
	public BiomeCanyon() {
		...
		redRock                   = Blocks.REDSTONE_BLOCK.getDefaultState();
		topBlock                  = redRock;
		fillerBlock               = redRock;
