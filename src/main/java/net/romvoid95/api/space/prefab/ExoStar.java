...
import net.romvoid95.api.space.enums.EnumLuminosityClass;
import net.romvoid95.api.space.enums.EnumSpectralClass;
import net.romvoid95.api.space.interfaces.IExoStar;
