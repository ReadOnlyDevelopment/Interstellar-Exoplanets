...
public class ExoGenFirTree extends ExoGenTreeBase {
	...
	public ExoGenFirTree(boolean isWorldGen, int minTreeHeight, IBlockState stateWood, IBlockState stateLeaves) {
		super(!isWorldGen);
