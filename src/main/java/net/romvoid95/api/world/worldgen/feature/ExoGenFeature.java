...
public abstract class ExoGenFeature {
	...
	public ExoGenFeature(Block featureBlock) {
	...
	public ExoGenFeature setStrengthFactor(float strengthFactor) {
	...
	public ExoGenFeature setMinY(int minY) {
	...
	public ExoGenFeature setMaxY(int maxY) {
	...
	public ExoGenFeature setChance(int chance) {
	...
	public ExoGenFeature setWater(boolean water) {
	...
	public ExoGenFeature setHeightType(HeightType heightType) {
	...
	public ExoGenFeature setValidGroundBlocks(ArrayList<Block> validGroundBlocks) {
