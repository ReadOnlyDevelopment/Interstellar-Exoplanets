...
public class ExoGenCustomSwampTree extends ExoGenTreeBase {
    ...
    public ExoGenCustomSwampTree(boolean isWorldGen, int minTreeHeight, IBlockState stateWood, IBlockState stateLeaves) {
        super(!isWorldGen);
