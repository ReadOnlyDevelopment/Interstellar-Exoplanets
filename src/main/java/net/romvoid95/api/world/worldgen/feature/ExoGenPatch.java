...
public class ExoGenPatch extends WorldGenerator {
	private final IBlockState state;
	private final int         size;
	private List<Block>       replaceableBlocks = new ArrayList<>();

	public ExoGenPatch(IBlockState state, int size, Block... replaceableBlocks) {
		this.state = state;
		this.size  = size;
	...
	public ExoGenPatch(IBlockState state, int size) {
