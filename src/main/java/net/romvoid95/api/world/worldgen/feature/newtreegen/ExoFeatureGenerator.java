...
public abstract class ExoFeatureGenerator extends WorldGenerator implements IBlockSettable {

	public ExoFeatureGenerator() {
		this(false);
	}

	public ExoFeatureGenerator(boolean notify) {
		super(notify);
	}
