...
public class ExoGenLake extends WorldGenerator {

    private final IBlockState liquid;
    private final IBlockState stone;
    private final boolean genStone;

    public ExoGenLake(IBlockState liquid, IBlockState stone) {
        this(liquid, stone, false);
    }

    public ExoGenLake(IBlockState liquid, IBlockState stone, boolean genStone) {
        this.liquid = liquid;
        this.stone = stone;
