...
public class ExoGenSwampTree extends ExoGenTreeBase {

    public final boolean isWorldGen;
    private final int minTreeHeight;
    private IBlockState stateWood = ExoBlocks.EXO_LOG.getDefaultState().withProperty(BlockExoLog.WOOD_TYPE, WoodType.MOLD);
    private IBlockState stateLeaves = ExoBlocks.EXO_LEAVES.getDefaultState().withProperty(BlockExoLeaves.VARIANT, LeafType.MOLD).withProperty(BlockExoLeaves.CHECK_DECAY, false);
    

    public ExoGenSwampTree(boolean isWorldGen, int minTreeHeight) {
        super(!isWorldGen);
