...
package net.romvoid95.space.wolf1061.b.worldgen.layers;

import net.minecraft.world.gen.layer.*;

public abstract class GenLayerWolfB extends GenLayer {
	public GenLayerWolfB(long l) {
		super(l);
	}

	public static GenLayer[] createWorld(long l) {
		GenLayer biomes = new GenLayerWolfBBiomes(l);
