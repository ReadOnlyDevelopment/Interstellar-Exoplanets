...
public class BiomeProviderWolfB extends BiomeProvider {
	...
	protected BiomeProviderWolfB() {
		this.body            = Planets.WOLF1061B;
		this.biomeCache      = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderWolfB(long seed, WorldType type) {
		this();
	...
	public BiomeProviderWolfB(World world) {
