...
import net.romvoid95.space.kepler1649.b.layer.GenLayerKepler1649B;

public class BiomeProviderKepler1649B extends BiomeProvider {
	...
	protected BiomeProviderKepler1649B() {
		this.body            = Planets.KEPLER1649B;
		this.biomeCache      = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderKepler1649B(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerKepler1649B.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes   = genLayers[1];
	}

	public BiomeProviderKepler1649B(World world) {
