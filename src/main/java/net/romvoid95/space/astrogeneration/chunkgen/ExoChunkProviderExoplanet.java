...
import net.romvoid95.space.astrogeneration.noise.NoiseModule;

public abstract class ExoChunkProviderExoplanet extends ExoChunkProviderBase {
	...
	public ExoChunkProviderExoplanet(World world, long seed, boolean flag) {
		super();
		this.worldObj = world;
