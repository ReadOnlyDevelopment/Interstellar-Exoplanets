...
public class WorldGenPlumTree extends WorldGenAbstractTree
{
    ...
    public WorldGenPlumTree(boolean notify, boolean useExtraRandomHeightIn, Block[] blocks)
    {
        super(notify);
        this.useExtraRandomHeight = useExtraRandomHeightIn;
		this.LOG = blocks[0].getDefaultState();
		this.LEAF = blocks[1].getDefaultState();
		this.PLUM = blocks[2].getDefaultState();
    }
