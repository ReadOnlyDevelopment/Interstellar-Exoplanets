...
public abstract class ModStructureTemplate extends StructureComponentTemplate {
	...
	public ModStructureTemplate(TemplateManager manager, String type, BlockPos pos, Rotation rotation,
			boolean overwriteIn) {
		super(0);
		this.pieceName = type;
	...
	public ModStructureTemplate(TemplateManager manager, String type, BlockPos pos, int distance, Rotation rotation,
			boolean overwriteIn) {
	...
	private void loadTemplate(TemplateManager manager) {
		Template template = manager.getTemplate((MinecraftServer) null,
				new ResourceLocation(ExoInfo.MODID, this.templateLocation() + "/" + this.pieceName));
	 ...
	 */
	public boolean isCollidingExcParent(TemplateManager manager, ModStructureTemplate parent,
