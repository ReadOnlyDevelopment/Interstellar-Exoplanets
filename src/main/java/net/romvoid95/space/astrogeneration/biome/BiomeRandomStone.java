...
public abstract class BiomeRandomStone extends ExoBiome {

	public BiomeRandomStone(BiomeDataBuilder biomeData, Block topBlock, Block fillerBlock) {
		super(biomeData.generate());
