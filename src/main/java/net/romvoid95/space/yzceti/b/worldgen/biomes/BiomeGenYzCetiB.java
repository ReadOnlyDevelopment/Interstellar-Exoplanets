...
public class BiomeGenYzCetiB extends YzCetiBBiomes {

	public BiomeGenYzCetiB(String name, float height, float variation) {
	...
	public void registerTypes(Biome b) {
		BiomeDictionary.addTypes(b, BiomeDictionary.Type.COLD, BiomeDictionary.Type.WASTELAND, BiomeDictionary.Type.DEAD,
