...
package net.romvoid95.space.trappist1.c.worldegnine;
...
public class Trappist1C_Plains extends WE_Biome {
	...
	public Trappist1C_Plains(double min, double max) {
		...
		standardBiomeLayers.add(TrappistBlocks.SharedTerrain.HOT_GROUND_1.getDefaultState(), TrappistBlocks.TrappistC.TRAP1C_DIRT_2.getDefaultState(), -256, 35, -256, 0, false);
