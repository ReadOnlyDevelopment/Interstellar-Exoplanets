...
import net.rom95.common.astronomy.kepler1649.KeplerBlocks;
import net.rom95.common.astronomy.trappist1.TrappistBlocks;
import net.rom95.common.astronomy.yzceti.YzCetiBlocks;
import net.rom95.common.block.decoration.BlockAlarmLight;
import net.rom95.common.block.decoration.BlockCellarLamp;
import net.rom95.common.block.decoration.BlockCustomHydraulic;
import net.rom95.common.block.decoration.BlockCustomLever;
import net.rom95.common.block.decoration.BlockElectronic;
import net.rom95.common.block.decoration.BlockInsetLamp;
import net.rom95.common.block.decoration.BlockMetalDecoration;
import net.rom95.common.block.decoration.BlockMetalDiagonal;
import net.rom95.common.block.decoration.BlockMetalLamp;
import net.rom95.common.block.decoration.BlockSatelliteAntenna;
import net.rom95.common.block.decoration.BlockStandConsole;
import net.rom95.common.block.decoration.BlockWallLamp;
import net.rom95.common.block.generic.BlockAlloy;
import net.rom95.common.block.generic.BlockMetal;
import net.rom95.common.block.machine.BlockAlloyRefinery;
import net.rom95.common.block.machine.BlockMetalFurnace;
import net.rom95.common.block.ore.BlockOreMetal;
import net.rom95.common.block.stairs.BlockConcrete1Stairs;
import net.rom95.common.block.stairs.BlockConcreteStairs;
import net.rom95.common.block.stairs.BlockRoofStairs;
import net.rom95.common.block.stairs.BlockSpaceQuartzMetalFrame;
import net.rom95.common.block.stairs.BlockSpaceQuartzStair;
import net.rom95.common.block.terrain.ExoLog;
