...
import net.rom95.api.event.ExoStormEvent;
import net.rom95.client.gui.rendering.Draw;
import net.rom95.client.gui.rendering.OpenGL;
...
public abstract class StormProvider implements Predicate<Entity>, IStormProvider {
	...
	public static void clientTickEvent (ClientTickEvent event) {
		if (CommonUtil.getMinecraft().world != null && CommonUtil.getMinecraft().world.provider instanceof IClimateProvider
	...
	public static void renderLast (RenderWorldLastEvent event) {
		if (CommonUtil.getMinecraft().world != null) {
			if (CommonUtil.getMinecraft().world.provider instanceof IClimateProvider) {
				...
				climate.getStormProvider()
						.renderStorm(event.getPartialTicks(), CommonUtil.getMinecraft().world, Minecraft.getMinecraft());
				ExoStormEvent stormEventPost = new ExoStormEvent.Post(storm);
				MinecraftForge.EVENT_BUS.post(stormEventPost);
			}
		}
