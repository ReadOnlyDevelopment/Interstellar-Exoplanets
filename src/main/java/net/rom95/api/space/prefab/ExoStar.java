...
package net.rom95.api.space.prefab;

import micdoodle8.mods.galacticraft.api.galaxies.Star;
import net.rom95.api.space.enums.EnumLuminosityClass;
import net.rom95.api.space.enums.EnumSpectralClass;
import net.rom95.api.space.interfaces.IExoStar;
