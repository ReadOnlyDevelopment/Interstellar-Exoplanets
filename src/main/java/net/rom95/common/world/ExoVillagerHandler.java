 ...
 */
package net.rom95.common.world;
...
public class ExoVillagerHandler {
	...
	public static void initAstronomerVillagerTrades () {
		PROF_ASTROLOGIST = new VillagerRegistry.VillagerProfession(ExoInfo.MODID
				+ ":astrologist", "exoplanets:textures/models/villager_astrologist.png", "exoplanets:textures/models/villager_astrologist_zombie.png");
		ForgeRegistries.VILLAGER_PROFESSIONS.register(PROF_ASTROLOGIST);

		VillagerRegistry.VillagerCareer career_astrologist = new VillagerRegistry.VillagerCareer(PROF_ASTROLOGIST, ExoInfo.MODID
				+ ":astrologist");

		career_astrologist
				.addTrade(1, new EmeraldForItemstack(new ItemStack(GCItems.oxTankHeavy, 1, 0), new EntityVillager.PriceInfo(8, 16)), new ItemstackForEmerald(new ItemStack(GCItems.canister, 1, 1), new EntityVillager.PriceInfo(-10, -6)), new ItemstackForEmerald(new ItemStack(GCItems.emergencyKit, 1, 1), new EntityVillager.PriceInfo(-3, -1)));
	}
	...
	private static class EmeraldForItemstack implements EntityVillager.ITradeList {
		...
		public void addMerchantRecipe (IMerchant merchant, MerchantRecipeList recipeList, Random random) {
			recipeList.add(new MerchantRecipe(copyStackWithAmount(this.buyingItem, this.buyAmounts
					.getPrice(random)), Items.EMERALD));
		}
	}
