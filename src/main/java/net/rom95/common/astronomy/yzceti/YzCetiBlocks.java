...
package net.rom95.common.astronomy.yzceti;

import net.minecraft.block.Block;
import net.rom95.api.registry.ExoRegistry;
import net.rom95.common.block.terrain.BlockGravel;
import net.rom95.common.block.terrain.BlockIgneousRock;
import net.rom95.common.block.terrain.BlockMetamorphicRock;
import net.rom95.common.block.terrain.BlockSediment;
import net.rom95.common.block.terrain.BlockSedimentaryRock;

public class YzCetiBlocks {

	public static void registerAll (ExoRegistry r) {
		// CetiB
