...
package net.rom95.common.astronomy.yzceti.c;
...
import net.rom95.common.world.mapgen.MapGenExoCaveGen;
import net.rom95.common.world.mapgen.MapGenExoRavinGen;

public class ChunkProviderYzCetiC extends ChunkProviderBase {

	public static final IBlockState BLOCK_FILL = YzCetiBlocks.CetiC.C_METAMORPHIC.getDefaultState();
	...
	public ChunkProviderYzCetiC(World worldIn, long seed, boolean mapFeaturesEnabled) {
		this.world = worldIn;
	...
	public void createCraters(int chunkX, int chunkZ, ChunkPrimer primer) {
		for (int cx = chunkX - 2; cx <= chunkX + 2; cx++) {
			for (int cz = chunkZ - 2; cz <= chunkZ + 2; cz++) {
				for (int x = 0; x < ChunkProviderYzCetiC.CHUNK_SIZE_X; x++) {
					for (int z = 0; z < ChunkProviderYzCetiC.CHUNK_SIZE_Z; z++) {
						if (Math.abs(this.randFromPoint(cx * 16 + x, (cz * 16 + z) * 1000)) < this.noiseGen4.getValue(
								x * ChunkProviderYzCetiC.CHUNK_SIZE_X + x, cz * ChunkProviderYzCetiC.CHUNK_SIZE_Z + z)
								/ ChunkProviderYzCetiC.CRATER_PROB) {
