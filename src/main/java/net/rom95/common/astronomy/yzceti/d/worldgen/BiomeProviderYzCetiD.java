...
package net.rom95.common.astronomy.yzceti.d.worldgen;
...
import net.rom95.common.astronomy.yzceti.d.worldgen.biomes.GenLayerYzCetiD;
import net.rom95.core.initialization.Planets;

public class BiomeProviderYzCetiD extends BiomeProvider {
	...
	public BiomeProviderYzCetiD(long seed, WorldType type) {
		this();
	...
	public BiomeProviderYzCetiD(World world) {
