...
package net.rom95.common.astronomy.trappist1.c;
...
import net.rom95.common.astronomy.trappist1.c.worldegnine.Trappist1C_Mountains;
import net.rom95.common.astronomy.trappist1.c.worldegnine.Trappist1C_Plains;
import net.rom95.common.astronomy.trappist1.c.worldegnine.Trappist1C_River;
...
public class WorldProviderTrappist1C extends WE_WorldProviderSpace {
	...
	public void genSettings (WE_ChunkProvider cp) {
		...
		standardOres.add(TrappistBlocks.SharedTerrain.HOT_GROUND_2.getDefaultState(), TrappistBlocks.TrappistC.T1C_TOP
				.getDefaultState(), 32, 64, 250, 25);
		standardOres.add(TrappistBlocks.SharedTerrain.HOT_GROUND_1.getDefaultState(), TrappistBlocks.TrappistC.T1C_TOP
				.getDefaultState(), 16, 64, 250, 20);
