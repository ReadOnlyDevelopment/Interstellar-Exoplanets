...
@EventBusSubscriber
public class StormProviderTrappist1E extends StormProvider {
		...
		if (world != null && this.isStormActive(world)) {
			for (Object o : world.loadedEntityList.toArray()) {
				if (o instanceof Entity) {
					...
					if (entity.world.provider instanceof WorldProviderTrappist1E) {
	...
	public static final Texture STORM_TEXTURE = new Texture(ExoInfo.MODID, "textures/enviroment/hellfire.png");
	...
	public boolean isStormApplicableTo (WorldProvider provider) {
		return provider instanceof WorldProviderTrappist1E;
	}
