package net.rom95.common.astronomy.trappist1.d;
...
import net.rom95.api.space.utility.AstronomicalConstants;
import net.rom95.api.world.ExoWorldProvider;
import net.rom95.api.world.IClimateProvider;
import net.rom95.api.world.ICloudProvider;
import net.rom95.api.world.IStormProvider;
import net.rom95.common.astronomy.trappist1.TrappistDimensions;
import net.rom95.common.astronomy.trappist1.d.biomes.BiomeOceananic;
import net.rom95.common.astronomy.trappist1.d.client.CloudProviderTrappist1D;
import net.rom95.common.astronomy.trappist1.d.client.StormProviderTrappist1D;
...
public class WorldProviderTrappist1D extends ExoWorldProvider implements IWeatherProvider, IClimateProvider {
	...
	public void genSettings (WE_ChunkProvider cp) {
		...
		terrainGenerator.worldSeaGenBlock = ExoFluids.fluidpressurized.getBlock().getDefaultState();//Blocks.WATER.getDefaultState();//ExoFluids.fluidBlockMantle.getDefaultState();
	...
	public Vector3 getFogColor () {
		return new Vector3(50 / 255.0F, 50 / 255.0F, 50 / 255.0F);
	}

	@Override
	public Vector3 getSkyColor () {
		float f = 0.6F - this.getStarBrightness(1.0F);
		return new Vector3(50 / 255.0F * f, 50 / 255.0F * f, 50 / 255.0F * f);
	}
