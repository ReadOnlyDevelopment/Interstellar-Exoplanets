package net.rom.exoplanets.astronomy.world;
...
public class WorldGenMinableExo extends ExoWorldGenMaster {
	...
	public WorldGenMinableExo(Block oreBlock, Block fillBlock, int numberOfBlocks) {
		this.oreBlock = oreBlock.getDefaultState();
		this.numberOfBlocks = numberOfBlocks;
		this.fillBlock = fillBlock.getDefaultState();
	}
	
	public WorldGenMinableExo(Block oreBlock, Block fillBlock, EnumOreGen oreGen) {
		this.oreBlock = oreBlock.getDefaultState();
