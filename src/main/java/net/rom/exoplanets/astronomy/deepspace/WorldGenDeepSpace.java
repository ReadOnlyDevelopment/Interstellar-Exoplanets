...
import net.rom.exoplanets.astronomy.deepspace.blocks.BlockBasicSpace.EnumBasicSpace;
import net.rom.exoplanets.astronomy.deepspace.blocks.BlockDeepStructure;
import net.rom.exoplanets.astronomy.deepspace.blocks.BlockFlooring.EnumBlockFlooring;
import net.rom.exoplanets.astronomy.deepspace.blocks.BlockInterior;
...
public class WorldGenDeepSpace extends WorldGenerator {
	private IBlockState exteriorBasic = EnumBasicSpace.DECO_1.getBlockByState();
	private IBlockState solid = EnumBasicSpace.BASE_METAL.getBlockByState();
	private IBlockState interiorWall = BlockInterior.EnumBlockInterior.DARK_GREY.getBlockByState();
	...
	private void slice(World world, BlockPos pos, int z) {
		IBlockState glass = (pos.getZ() >> 4) % 6 == 0 ? exteriorBasic
				: DeepSpaceBlocks.glassProtective.getDefaultState();
