...
public class YzCetiBlocks {
	...
	public static class CetiB {
		...
		public void add() {
			blocks.add(B_LOOSE_SEDIMENT);
			blocks.add(B_DARK_LOOSE_SEDIMENT);
			blocks.add(B_GRAVEL);
			blocks.add(B_IGNEOUS);
			blocks.add(B_METAMORPHIC);
			blocks.add(B_SEDIMENTARYROCK);
		}
	...
	public static class CetiC {
		...
		public void add() {
			blocks.add(C_LOOSE_SEDIMENT);
			blocks.add(C_DARK_LOOSE_SEDIMENT);
			blocks.add(C_GRAVEL);
			blocks.add(C_IGNEOUS);
			blocks.add(C_METAMORPHIC);
			blocks.add(C_SEDIMENTARYROCK);
		}
	}
	...
	public static class CetiD {
		...
		public void add() {
			blocks.add(D_LOOSE_SEDIMENT);
			blocks.add(D_DARK_LOOSE_SEDIMENT);
			blocks.add(D_GRAVEL);
			blocks.add(D_IGNEOUS);
			blocks.add(D_METAMORPHIC);
			blocks.add(D_SEDIMENTARYROCK);
		}
	}
