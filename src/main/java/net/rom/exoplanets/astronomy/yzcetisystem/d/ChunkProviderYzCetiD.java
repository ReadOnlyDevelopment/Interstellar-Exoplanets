...
//
//public class ChunkProviderYzCetiD extends ChunkProviderBase {
//
...
//	
//	private final BiomeDecoratorYzCetiD biomeDecoratorAltum = new BiomeDecoratorYzCetiD();
//	private Random rand;
...
//	private MapGenExoCaveGen caveGenerator = new MapGenExoCaveGen(BlocksRegister.YZD_SEDEMENTARY);
//	private MapGenExoCaveGen caveGenerator2 = new MapGenExoCaveGen(BlocksRegister.YZD_SEDEMENTARY);
//	private final MapGenExoRavinGen ravineGenerator = new MapGenExoRavinGen(BlocksRegister.YZD_SEDEMENTARY);
...
//	
//	public ChunkProviderYzCetiD(World worldIn, long seed, boolean mapFeaturesEnabled) {
//		this.world = worldIn;
...
//				for (int x = 0; x < ChunkProviderYzCetiD.CHUNK_SIZE_X; x++) {
//					for (int z = 0; z < ChunkProviderYzCetiD.CHUNK_SIZE_Z; z++) {
//						if (Math.abs(this.randFromPoint(cx * 16 + x, (cz * 16 + z) * 1000)) < this.noiseGen4.getValue(x
//								* ChunkProviderYzCetiD.CHUNK_SIZE_X + x, cz * ChunkProviderYzCetiD.CHUNK_SIZE_Z + z)
//								/ ChunkProviderYzCetiD.CRATER_PROB) {
