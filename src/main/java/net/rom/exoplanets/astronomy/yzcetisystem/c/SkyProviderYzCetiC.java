...
public class SkyProviderYzCetiC extends SkyProviderBase {
    ...
    public SkyProviderYzCetiC(float solarSize) {
        this.solarSize = 26.0F * solarSize;
    }
    ...
    protected void renderObjects(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        if(SConfigCore.enableRealism) {
            this.renderSolar(SkyProviderYzCetiC.YZCETI_A_REALISTIC, this.solarSize, false, true, 4.0F);
        } else {
            this.renderSolar(SkyProviderYzCetiC.YZCETI_A, this.solarSize, false, true, 4.0F);
        }
        this.renderObject(1.0F, 0.0F, 220.0F, false, SkyProviderYzCetiC.YZCETI_C, partialTicks);
        this.renderObject(2.55F, 0.0F, 220.0F, false, SkyProviderYzCetiC.YZCETI_D, partialTicks);
    }
