...
public class SkyProviderC extends SkyProviderBase {
	...
	private static final ResourceLocation cetiB = new ResourceLocation(ExoInfo.MODID, "textures/gui/celestialbodies/yz_ceti/yz_ceti_b.png");
	private static final ResourceLocation cetiD = new ResourceLocation(ExoInfo.MODID, "textures/gui/celestialbodies/yz_ceti/yz_ceti_d.png");
	...
	protected void rendererSky(Tessellator tessellator, BufferBuilder buffer, float f10, float ticks) {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.cetiB);
	...
	protected ResourceLocation sunImage() {
		return new ResourceLocation(ExoInfo.MODID, "textures/gui/celestialbodies/yz_ceti/yz_ceti_star.png");
	}
