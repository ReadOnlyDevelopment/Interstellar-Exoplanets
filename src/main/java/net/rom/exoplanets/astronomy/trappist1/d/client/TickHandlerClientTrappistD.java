...
import net.rom.exoplanets.util.ExoplanetsSounds;
		...
		if (player == event.player) {
			if (!ConfigManagerVenus.disableAmbientLightning) {
				...
				if (player.getRNG().nextInt(300 + (int) (800F * minecraft.world.rainingStrength)) < 8
						&& minecraft.world.provider instanceof WorldProviderTrappist1D) {
					...
					minecraft.world
							.playSound(player, posX, posY, posZ, ExoplanetsSounds.CUSTOM_THUNDER, SoundCategory.WEATHER, 350.0F
