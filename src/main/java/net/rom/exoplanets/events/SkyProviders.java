...
import net.rom.exoplanets.astronomy.deepspace.SkyProviderDeepSpace;
    ...
    public void onClientTick(ClientTickEvent event) {
        ...
        if (event.phase == Phase.START && player != null && world != null) {
            ...
            if (world.provider instanceof WorldProviderDeepSpace) {
                if (world.provider.getSkyRenderer() == null) {
                    world.provider.setSkyRenderer(new SkyProviderDeepSpace(new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/jupiter.png"), true, true));
