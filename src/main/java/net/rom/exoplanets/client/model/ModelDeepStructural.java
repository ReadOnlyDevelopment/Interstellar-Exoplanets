 ...
 */
package net.rom.exoplanets.client.model;
...
import net.rom.exoplanets.astronomy.deepspace.TransformerHooksClient;
...
public class ModelDeepStructural implements IBakedModel
{
    ...
    public ModelDeepStructural (boolean invert)
    {
        ...
        this.setupAllQuads(new ResourceLocation(ExoInfo.MODID, "blocks/grey"));
    }
    ...
    {
        return Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(ExoInfo.MODID + ":blocks/grey");
    }
