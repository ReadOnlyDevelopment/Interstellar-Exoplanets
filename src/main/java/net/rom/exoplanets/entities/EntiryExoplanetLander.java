...
public class EntiryExoplanetLander extends EntityLanderBase implements IIgnoreShift, ICameraZoomEntity{
	private double lastMotionY;

	public EntiryExoplanetLander(World var1) {
		super(var1);
		this.setSize(3.0F, 4.25F);
	}
	
	public EntiryExoplanetLander(EntityPlayerMP player) {
		super(player, 0.0F);
	}
