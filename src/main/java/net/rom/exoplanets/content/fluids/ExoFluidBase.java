...
public class ExoFluidBase extends Fluid {
     ...
     *            the flowing
     */
    public ExoFluidBase(String fluidName, ResourceLocation still, ResourceLocation flowing)
    {
     ...
     *            the map color
     */
    public ExoFluidBase(String fluidName, ResourceLocation still, ResourceLocation flowing, int mapColor)
    {
     ...
     *            the overlay alpha
     */
    public ExoFluidBase(String fluidName, ResourceLocation still, ResourceLocation flowing, int mapColor, float overlayAlpha)
    {
	 ...
	 */
	@Override
	public ExoFluidBase setColor(int parColor) {
		mapColor = parColor;
		return this;
	}
	 ...
	 * @return the fluid
	 */
	public ExoFluidBase setAlpha(float parOverlayAlpha) {
	 ...
	 * 
	 * @see
	 * net.minecraftforge.fluids.Fluid#setEmptySound(net.minecraft.util.SoundEvent)
	 */
	@Override
	public ExoFluidBase setEmptySound(SoundEvent parSound) {
		emptySound = parSound;
		return this;
	}
	 ...
	 * 
	 * @see
	 * net.minecraftforge.fluids.Fluid#setFillSound(net.minecraft.util.SoundEvent)
	 */
	@Override
	public ExoFluidBase setFillSound(SoundEvent parSound) {
		fillSound = parSound;
		return this;
	}
	 ...
	 */
	public ExoFluidBase setHasBucket(boolean parEnableBucket) {
