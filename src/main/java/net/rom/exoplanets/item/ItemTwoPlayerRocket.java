...
import net.rom.exoplanets.entities.EntityTwoPlayerRocket;
import net.rom.exoplanets.tabs.CreativeExoTabs;

public class ItemTwoPlayerRocket extends Item implements IHoldableItem {
    public ItemTwoPlayerRocket(String assetName) {
        this.setMaxDamage(0);
    ...
    public CreativeTabs getCreativeTab() {
        return CreativeExoTabs.ITEMS_CREATIVE_TABS;
    }
