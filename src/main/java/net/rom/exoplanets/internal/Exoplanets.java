...
import static net.rom.exoplanets.conf.ConfigPlanets.*;
...
public enum Exoplanets implements IStringSerializable {
	...
	TRAPPIST1D		("Trappist1D", 	trappist1, 	id_trap_d, 		0.6F, 	0.41, 	0.772, 		null),
	...
	WOLF1061B		("Wolf1061B", 	wolf1061, 	id_wolf_b, 		0.3F, 	1.91, 	1.21, 		null),
	WOLF1061C		("Wolf1061C", 	wolf1061, 	id_wolf_c, 		0.6F, 	3.41, 	1.66, 		null),
	WOLF1061D		("Wolf1061D", 	wolf1061, 	id_wolf_d, 		2.5F, 	7.7, 	r(0.24), 	null),
