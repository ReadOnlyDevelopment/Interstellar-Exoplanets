...
public class OverworldOreGen implements IWorldGenerator {
	...
	public OverworldOreGen() {
		ORELIMONITE = new WorldGenMinable(ExoBlocks.OVERWORLD_ORE.getStateFromMeta(0), 20);
		ORERUTHENIUM = new WorldGenMinable(ExoBlocks.OVERWORLD_ORE.getStateFromMeta(1), 20);
		ORERUTILE = new WorldGenMinable(ExoBlocks.OVERWORLD_ORE.getStateFromMeta(2), 20);
	}
